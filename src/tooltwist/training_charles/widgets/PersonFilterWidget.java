...
//import tooltwist.training_charles.productionHelpers.PersonFilterProductionHelper;
import com.dinaa.ui.UimData;
import com.dinaa.ui.UimHelper;

/**
 * Filter widget for person
 */
public class PersonFilterWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "personFilter_preview.html";
	private static final String SNIPPET_DESIGN = "personFilter_design.html";
	private static final String SNIPPET_PRODUCTION = "personFilter_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "personFilter_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance ,"personFilter_jsHeader.js"),

//				// Include a CSS snippet
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "personFilter_cssHeader.css")),
			};
			codeInserterList.add(arr);
		}
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, PersonFilterProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(PersonFilterProductionHelper.class.getName()));
			}
		}

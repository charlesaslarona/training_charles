...
import tooltwist.training_charles.productionHelpers.WeatherProductionHelper;
 ...
 * Weather Information
 */
public class WeatherWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "weather_preview.html";
	private static final String SNIPPET_DESIGN = "weather_design.html";
	private static final String SNIPPET_PRODUCTION = "weather_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "weather_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "weather_jsHeader.js"),

//				// Include a CSS snippet
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "weather_cssHeader.css")),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, WeatherProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(WeatherProductionHelper.class.getName()));
			}
		}

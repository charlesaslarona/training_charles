...
<%@page import="tooltwist.training_charles.productionHelpers.PersonListProductionHelper"%>
...
<!-- ********** INSERT HTML HERE ********** -->
<div %%idDefinition%% class="PersonList" style="width:200px; border-style:solid; border-width:1px; text-align: center;">
	personList
